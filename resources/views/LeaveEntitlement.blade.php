...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Leave Entitlement Creation</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Casual Leave">
                    </div>
                ...
                <div class="row g-4 mb-3">
                    ...
                    <!-- Privilege Leave -->
                    <div class="col-md-3">
                        <label class="form-label">Privilege Leave</label>
                        <input type="text" class="form-control" placeholder="Enter Leave">
                    </div>

                    <!-- Credit Limit -->
                    <div class="col-md-3">
                        <label class="form-label">Credit Limit of Preveilege Leave</label>
                        <input type="text" class="form-control" placeholder="Enter Leave">
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 d-flex align-items-center">
                                <label class="d-flex align-items-center gap-2" style="font-size:15px;">
                                    <input type="radio" name="periodType" checked>
            ...
            <table class="table table-bordered mb-0 custom-table">
                <thead>
                    <tr>
                        ...
                        <th>Credit Limit of Privilege Leave</th>
                    </tr>
                </thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Hepatitis screening</td>
                        <td>Hearing aid adjustment</td>
                        <td>General fatigue</td>
                        <td>Burn wound dressing</td>
                    </tr>
                    ...
                    <tr>
                        <td>3</td>
                        <td>Federal Bank</td>
                        <td>Gastric problem</td>
                        <td>Eye check-up</td>
                        <td>Diabetes check-up</td>
                        <td>Psychiatric counseling</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>Grandparent’s medical care</td>
                        <td>Fever and weakness</td>
                    ...
                    <tr>
                        ...
                        <td>Sunburn treatment</td>
                        <td>Hepatitis screening</td>
                        <td>Dizziness treatment</td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[5];
