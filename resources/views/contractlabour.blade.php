...
<head>
    ...
    <title>Payaasaan - Contract Labour</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Contract Labour Master Entry</span>
            </div>
    ...
    <div class="col-md-3 d-flex align-items-end">
        <button class="btn btn-primary px-4">Sync Aadhar</button>
    </div>
</div>
                ...
                <div class="row g-4 mb-3">
                    ...
                    <!-- Category Input -->
                    <div class="col-md-3">
                        <label class="form-label">Contractor Labour Code<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Enter Contractor Labour Code">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Contractor Labour Name<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Enter Contractor Labour Name">
                    </div>
...
================================ -->
                <div class="card p-0 mt-4 cardborder">
                    ...
                    <div class="p-4">
                        ...
                        <label class="form-label">Photo</label>
                            ...
                            <div class="col-md-3">
                                <label class="form-label">ESI Dispansary <span class="text-danger">*</span></label>
                                <div class="position-relative">
                                    <select class="form-select">
                        ...
                        <div class="row g-4 mb-2">
                         ...
                         <div class="row mt-4">
                            ...
                            <div class="row" style="margin-top:20px; ">
                                ...
                                <!-- Type of Resgination-->
                                <div class="col-md-3">
                                    <label class="form-label">Type of Resignation<span class="text-danger">*</span> </label>
                                    <select class="form-select">
                                    <option>Select Type </option>
                                </select>
                                </div>
                ...
                <div class="card p-0 mt-4 cardborder">
                    <div class="cardheader">
                        ...
                        <span>Leave Accounting Period</span>
                ...
                <div class="d-flex justify-content-end gap-3 sticky-footer mt-4">
                    <button class="btn btn-outline-primary px-4">Save as Draft</button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[16];
