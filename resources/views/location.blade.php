...
<head>
    ...
    <title>Payaasaan - Location Creation</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Location Master</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 align-items-end mb-3">
                    ...
                    <!-- City / Panchayat -->
                    <div class="col-md-3">
                        <label class="form-label">City / Panchayat</label>
                        <input type="text" class="form-control" placeholder="Enter City / Panchayat">
                    </div>

                    <!-- Add Button -->
                    <div class="col-md-2 d-flex align-items-end" style="margin-top: 5px;">
                        <button class="btn btn-primary px-4" style="height:38px;">Add</button>
                    </div>
                    ...
                    <div class="p-4">
                        ...
                        <div class="d-flex align-items-center gap-3 mb-3">
                            <div class="position-relative" style="width:260px;">
                                <input type="text" class="form-control" placeholder="Search by UAN No.">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[9];
