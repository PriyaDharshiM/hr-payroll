...
<head>
    ...
    <title>Payaasaan - Revision Configuration</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Revision Configuration</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label">Fixed Components <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                    ...
                    <div class="col-md-3">
                        <label class="form-label">Arrear Components <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                                <option>Select</option>
                            </select>
                    ...
                    <div class="col-md-3 d-flex  gap-4 ">
                        <label class="d-flex align-items-center gap-2">
                            ...
                            <span class="size-of-font">LOP Applicability</span>
                        </label>
                    </div>
                    ...
                    <div class="col-md-3 d-flex  gap-4 ">
                        <label class="d-flex align-items-center gap-2">
                            <input type="checkbox" name="category_type">
                            <span class="size-of-font">Statutory Deducation Applicability</span>
                        </label>
                    </div>
                ...
                <!-- BASIC DETAILS CARD -->
                <div class="card p-0 cardborder mt-2">

                    <!-- Header -->
                    <div
                       class="cardheader">
                        Revision Configuration List
                    </div>
                            ...
                            <table class="table table-bordered mb-0 custom-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Statutory Deduction Applicability</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>Abstergo Ltd.</td>
                                        <td>Fcorp - Futures Enterprises</td>
                                        <td>Feature/FDLD - 1204</td>
                                        <td>Service</td>
                                        <td>₹2,50,000</td>
                                        <td>₹4,10,000</td>
                                        <td>Yes</td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#configMenu .submenu-item')[4];
