...
<head>
    ...
    <title>Payaasaan - Formula Creation</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Formula Creation</span>
            </div>
    ...
    <div style="display:flex; min-height: calc(100vh - 60px);">
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="col d-flex justify-content-end align-items-center gap-3">
                            ...
                            <button type="button" class="btn btn-outline-primary d-flex align-items-center gap-2 px-2">
                                <i class="bi bi-upload"></i> Import Details
                            </button>
                    ...
                    <div class="card p-0 cardborder">
                        ...
                        <div class="p-3">
                            <div class="row g-4 mb-2">
                                <div class="col-md-3">
                                    <label class="form-label">Formula Type <span class="text-danger">*</span></label>
                                    <div class="position-relative">
                                        <select class="form-select">
                                        ...
                                        <table class="table table-bordered mb-0 custom-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center" style="width:147px;">Allow Negative Value</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"><input type="checkbox"></td>
                                                    <td class="text-center">
                                                        <i class="bi bi-pencil-square text-primary me- icon-bold"></i>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                ...
                <div class="d-flex justify-content-end gap-3 mt-4 sticky-footer">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[15];
