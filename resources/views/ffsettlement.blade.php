...
<body>
    ...
    <div style="display:flex; min-height: calc(100vh - 60px);">
        ...
        <main class="content-area bg-white">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control"
                                    placeholder="Enter Miscellaneous Deduction">
                            </div>
            ...
            <div class="d-flex justify-content-end gap-3 sticky-footer mt-4">
                <button class="btn btn-outline-primary px-4">View Details</button>
                <button class="btn btn-primary px-4">Payslip</button>
            </div>
    </div>
