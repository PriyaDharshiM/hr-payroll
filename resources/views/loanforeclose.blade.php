...
<head>
    ...
    <title>Payaasaan - Loan Foreclose</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Loan Foreclose</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <!-- Radio Buttons -->
                    <div class="col-md-3 d-flex align-items-center gap-4" style="margin-top:10px;">
                    ...
                    <div class="col-md-3 d-flex align-items-end justify-content-end">
                        <button class="btn btn-primary px-4">Show Details</button>
                    </div>
                ...
                <div class="card p-0 cardborder">
                    ...
                    <div class="p-4">
                        ...
                        <!-- Foreclose Amount + Apply Month + Apply Year + Buttons -->
                        <div class="row g-4 mb-3">

                            <!-- Foreclose Amount -->
                            <div class="col-md-3">
                                <label class="form-label">Foreclose Amount</label>
                            ...
                            <div class="col-md-4 d-flex align-items-end gap-2 justify-content-end">
                                <button class="btn btn-primary px-4">Foreclose</button>
                                <button class="btn btn-primary px-4">Waived Off</button>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[12];
