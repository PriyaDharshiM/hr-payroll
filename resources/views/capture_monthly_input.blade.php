...
<head>
    ...
    <title>Payaasaan - Capture Monthly Input</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Capture Monthly Input</span>
            </div>
             ...
             <div class="card p-0 mb-4" style="border-radius:12px; border:1px solid #E5E5E5; margin-top: 20px;">
                ...
                <div class="p-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-3">
                            <label class="form-label">Miscellaneous Payment <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-3">
                            <label class="form-label">Miscellaneous Deduction<span class="text-danger">*</span></label>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[0];
