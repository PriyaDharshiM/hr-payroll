...
<head>
    ...
    <title>Payaasaan - Holiday Creation</title>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Holiday Creation</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" class="form-control" placeholder="Enter Category">
                    </div>
...
================================ -->
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[4];
