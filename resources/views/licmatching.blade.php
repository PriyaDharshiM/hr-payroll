...
<head>
    ...
    <title>Payaasaan - Lic Matching</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Lic Matching</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-4">
                    ...
                    <!-- LIC Policy No 1 -->
                    <div class="col-md-3">
                        <label class="form-label">LIC Policy No 1</label>
                        <input type="text" class="form-control" placeholder="Enter LIC Policy Number">
                    </div>

                    <!-- LIC Policy No 1 Premium -->
                    <div class="col-md-3 d-flex align-items-end">
                        <input type="text" class="form-control" placeholder="Enter LIC Policy No 1 Premium">
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <i class="bi bi-eye text-primary icon-bold"></i>
                                        </td>
                                    </tr>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#configMenu .submenu-item')[8];
