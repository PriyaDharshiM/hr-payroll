...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Return S+E</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <label class="form-label">Ending Month <span class="text-danger">*</span></label>
                       <div class="input-group month-input">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageMain = document.querySelector('[data-bs-target="#returnsMenu"]');
            const pageSub = document.querySelectorAll('#returnsMenu .submenu-item')[0];

            pageMain.classList.add('active', 'page-active');
            document.getElementById('returnsMenu').classList.add('show');
