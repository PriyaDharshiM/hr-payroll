...
<head>
    ...
    <title>Payaasaan - Loan Reverse Foreclose</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Loan Reverse Foreclose</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3 d-flex align-items-end justify-content-end">
                        <button class="btn btn-primary px-4">Show Foreclose</button>
                    </div>
                ...
                <div class="card p-0 cardborder">
                    ...
                    <div class="p-4">
                        ...
                        <!-- Apply Month + Apply Year + Reverse Button -->
                        <div class="row g-4 mb-3">
                            ...
                            <!-- Reverse Foreclose Button -->
                            <div class="col-md-3 d-flex align-items-end">
                                <button class="btn btn-primary px-4">Reverse Foreclose</button>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[13];
