...
<head>
    ...
    <title>Payaasaan - Loan Deviation</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Loan Deviation</span>
            </div>
    ...
    <div style="display:flex; min-height: calc(100vh - 60px);">
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mt-3">
                    ...
                    <div class="col-md-6 text-end">
                        <button class="btn btn-primary mt-4" style="font-size:14px;">
                            Show Details
                        </button>
                    </div>
            ...
            <!-- ============================
               LOAN POSTING  DETAILS
                =============================== -->
            <div class="card p-0 mt-4 mb-4" style="border-radius:12px; border:1px solid #E5E5E5;">

                    <!-- Header -->
                    <div class="d-flex justify-content-between align-items-center px-3 py-3"
                        style="background:#F7F7F7; border-radius:12px 12px 0 0;">
                        <h6 class="m-0 fw-semibold">Loan Posting Details</h6>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[1];
