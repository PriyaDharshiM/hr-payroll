...
<head>
    ...
    <title>Payaasaan - Attendance consolidation</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Attendance consolidation</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mt-3">
                    ...
                    <div class="col-md-6 d-flex align-items-center justify-content-between ">
                        ...
                        <label class="d-flex align-items-center gap-1">
                            <input type="radio" name="category" value="selective">
                            <span class="mas">Selective Employee</span>
                        </label>

                        <label class="d-flex align-items-center gap-1">
                            <input type="radio" name="category" value="single">
                    ...
                    <div class="col-md-6 text-end">
                        ...
                        <button class="btn btn-primary px-4">Consolidate</button>
                    </div>
                </div>


                <!-- Attendance Upload Details -->
                <div class="card p-0 mb-4" style="border-radius:12px; border:1px solid #E5E5E5;margin-top: 30px;">

                    <!-- Header -->
                    <div class="d-flex justify-content-between align-items-center px-3 py-3"
                        style="background:#F7F7F7; border-radius:12px 12px 0 0;">
                        <h6 class="m-0 fw-semibold">Attendance Upload Details</h6>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered mb-0 custom-table ">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>Tech-Technologies Corporatior</td>
                                                <td>Invision</td>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td>FCorp- Futures Enterprise</td>
                                                <td>Google</td>
                                                <td>Dienstleistungsbranche</td>
                                                <td>Development</td>
                                                <td>May</td>
                                                <td>2011</td>
                                                <td>Single Employee</td>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>Zeta-Zeta Enterprise</td>
                                                <td>Entrata</td>
                                                <td>Nahrungsmittelindustrie</td>
                                                <td>Remote work</td>
                                                <td>July</td>
                                                <td>2018</td>
                                                <td>Selective Employee</td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3">
                                                        <i class="bi bi-eye" style="font-size:20px; color:#007bff;"></i>
                                                        <i class="bi bi-trash"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[6];
