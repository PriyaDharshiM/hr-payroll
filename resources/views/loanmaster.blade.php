...
<head>
    ...
    <title>Payaasaan - Loan Master Creation</title>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Loan Master</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label">Loan Code<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Loan Code">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Loan Description<span class="text-danger">*</span></label>
                        <input type="text" class="form-control" placeholder="Loan Description">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Type of Credit <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                                <option>Loan</option>
                            </select>
                    ...
                    <div class="col-md-3 d-flex" style="margin-top:50px;">
                                <label class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="checkfont">Interest Applicable</span>
                                </label>
                            </div>
...
================================ -->
                <div class="card p-0 mt-4 cardborder">
                    ...
                    <div class="p-4">
                        <div class="row g-4">
                            ...
                            <!-- Description -->
                            <div class="col-md-3">
                                <label class="form-label">Principal Components <span class="text-danger">*</span></label>
                                <div class="position-relative">
                                    <select class="form-select">
                                        <option>Select Principal Components</option>
                                    </select>
                                </div>
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Interest Components <span class="text-danger">*</span></label>
                                <div class="position-relative">
                                    <select class="form-select">
                                        <option>Select Interest Components</option>
                                    </select>
                                </div>
                            </div>

                            <div class="col-md-3">
                                <label class="form-label">Type of Interest <span class="text-danger">*</span></label>
                                <div class="position-relative">
                                    <select class="form-select">
                            ...
                            <div class="col-md-3 d-flex" style="margin-top: 50px">
                                <label class="d-flex align-items-center gap-2">
                                    <input type="checkbox" checked>
                                    <span class="checkfont">Principal starts from First Month</span>
                                </label>
                            </div>
                             ...
                             <div class="col-md-3 d-flex" style="margin-top: 50px">
                                <label class="d-flex align-items-center gap-2">
                                    <input type="checkbox" checked>
                                    <span class="checkfont">Interest Can be Waived It</span>
                                </label>
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[10];
