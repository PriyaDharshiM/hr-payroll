...
<head>
    ...
    <title>Payaasaan -  Income Matching</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Income Matching</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                <div class="row g-4 mb-3">
                    ...
                    <!-- Final Year  -->
                    <div class="col-md-3">
                        <label class="form-label">Final Year<span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                                <option>Select Final Year</option>
                            </select>
                ...
                <div class="row g-4 mt-3">
                    ...
                    <!-- Earned Components-->
                    <div class="col-md-3">
                        <label class="form-label">Earned Component</label>
                        <input type="text" class="form-control" placeholder="Enter Earned Component">
                    </div>

                    <!-- Fixed Component-->
                    <div class="col-md-3">
                        <label class="form-label">Fixed Component <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                                <option>Select Fixed Component</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <!-- Exemption-->
                    <div class="col-md-3">
                        <label class="form-label">Exemption<span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                                <option>Select Exemption</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <!-- Add Components-->
                    <div class="col-md-3">
                        <label class="form-label">Add Components<span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                ...
                <!-- Section Matching -->
                <div class="card p-0 cardborder" style="margin-top: 50px;">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="row g-4 mt-2">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="d-flex align-items-center gap-4 mt-2">
                                        <label class="d-flex align-items-center gap-2" style="font-size: 12px;">
                                            <input type="checkbox" name="regime_old">
                                            <span>Old Regime</span>
                                        </label>

                                        <label class="d-flex align-items-center gap-2" style="font-size: 12px;">
                                            <input type="checkbox" name="regime_new">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control mt-2" placeholder="Enter Order No">
                                </div>
                            ...
                            <div class="row g-2 mt-2">
                                ...
                                <div style="position: relative; width: 60%; max-width: 280px;">
                                    <input type="text" class="form-control" placeholder="Search by Company,Branch etc"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[7];
