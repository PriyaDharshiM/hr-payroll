...
<head>
    ...
    <title>Payaasaan - Capture Weekly Holiday</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Leave Type Creation</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3 align-items-end">
                    ...
                    <div class="col-md-6 d-flex justify-content-end gap-2">
                                <button class="btn btn-outline-primary px-4"><i class="bi bi-file-earmark-arrow-up"></i> Export</button>
                            ...
                            <table class="table table-bordered mb-0 custom-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Casual Leave</td>
                                        <td>Fifth Iteration - 90% of non payers</td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[11];
