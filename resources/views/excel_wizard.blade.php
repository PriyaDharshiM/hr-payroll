...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Excel Wizard</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                                    ...
                                    <table class="table table-bordered mb-0 custom-table ">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Contractor Address 2</th>
                                                <th>state</th>
                                                <th>City</th>
                                                <th>Pincode</th>
                                                <th>Email Id</th>
                                                <th>Commencement of Work</th>
                                                <th>Contractor Short Name</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Robert Fox</td>
                                                <td>Jenny Wilson</td>
                                                <td>7529 E Pecan Rd.</td>
                                                <td>775 Rolling Green Rd.</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>8080 Railroad st.</td>
                                                <td>7529 E. Pecan st.</td>
                                                <td>John Qunicy Adams</td>
                                                <td>Naperville</td>
                                                <td>600 987</td>
             ...
             Deduction
                ...
                <div class="card p-0 mt-4" style="border-radius:12px; border:1px solid #E5E5E5;">
                    ...
                    <!-- Header -->
                    <div class="cardheader d-flex align-items-center justify-content-between"
                        onclick="toggleDropdown('deductionContent')">
                        <span>Deduction</span>
                        <span class="arrow-icon" id="arrowIcon"
                            style="display:inline-block; font-size:24px; color:#2b2a2a">
                            <i class="bi bi-arrow-down-circle"></i>
                    ...
                    <!-- Body -->
                        <!-- Dropdown Content -->
                        <div class="dropdown-content" id="deductionContent" style="display:none;">
                            <div class="row g-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#reportMenu .submenu-item')[23];
