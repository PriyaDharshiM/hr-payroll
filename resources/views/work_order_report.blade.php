...
<head>
    ...
    <title>Payaasaan - Work Order Report</title>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Work Order Report</span>
            </div>
    ...
    <div style="display:flex; min-height: calc(100vh - 60px);">
        ...
        <main class="content-area bg-white">
            ...
            <div class="col-md-3 d-flex align-items-center">
                <label class="d-flex align-items-center gap-2 me-5">
                    <input type="radio" name="category">
                    <span class="mas">Core</span>
                </label>

                <label class="d-flex align-items-center gap-2 ms-5">
                    <input type="radio" name="category">
          ...
          <div class="col-md-3">
            ...
            <!-- Column 4: Month (input type="month") -->
            <div class="col-md-3">
...
<div class="row mt-3 align-items-end">
    ...
    <div class="col-md-9 d-flex justify-content-end gap-3">
...
<!-- Header -->
                ...
                <div class="p-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div style="position: relative; width: 60%; max-width: 280px;">
                            <input type="text" class="form-control" placeholder="Search by Employee No "
                            ...
                            <table class="table table-bordered mb-0 custom-table ">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Month</th>
                                        <th>Year</th>
                                        <th>Work Order with Attendance</th>
                                        <th>Work Order Days</th>
                                    </tr>
                                </thead>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#reportMenu .submenu-item')[11];
