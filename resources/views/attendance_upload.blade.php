...
<head>
    ...
    <title>Payaasaan - Attendance Upload</title>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Attendance Upload</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                <div class="row g-4 mb-3">
                    ...
                    <!-- Contractor Labour Code-->
                    <div class="col-md-3">
                        <label class="form-label">Contractor Labour Code</label>
                        <input type="text" class="form-control" placeholder="Enter Contractor Labour">
                    </div>
...
@include('partials.footer')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[4];
