...
<head>
    ...
    <title>Payaasaan - Wage Slip Mail</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Wage Slip Mail</span>
            </div>
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="row g-3 align-items-end mt-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="month" class="form-control" placeholder="Select Year">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-4 mt-4">
                                <label class="d-flex align-items-center gap-2 mb-4">
                                    <input type="radio" name="category_type" value="core" required>
                                    <span style="font-size: 12px;">All employees</span>
                                </label>

                                <label class="d-flex align-items-center gap-2 mb-4">
                                    <input type="radio" name="category_type" value="contract">
                                    <span style="font-size: 12px;">Multiple employees</span>
                                </label>

                                <label class="d-flex align-items-center gap-2 mb-4">
                                    <input type="radio" name="category_type" value="contract">
                                    <span style="font-size: 12px;">Single employees</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <textarea type="text" class="form-control" cols="3" rows="3" placeholder="Enter Description for Sending Payslips"></textarea>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#reportMenu .submenu-item')[6];
