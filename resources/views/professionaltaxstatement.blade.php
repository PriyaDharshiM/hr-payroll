...
<head>
    ...
    <title>Payaasaan - Professional Tax Statement</title>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Professional Tax Statement</span>
            </div>
...
<div class="table-responsive">
    <table class="table table-bordered mb-0 custom-table">
        <thead>
            ...
            <tr>
                ...
                <th colspan="3" class="text-center">Existing</th>
                <th colspan="3" class="text-center">Revised</th>
                <th colspan="3" class="text-center">Arrear</th>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#reportMenu .submenu-item')[3];
