...
<head>
    ...
    <title>Payaasaan - user Creation</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">User Creation</span>
            </div>
    ...
    <div style="display:flex; min-height: calc(100vh - 60px);">
        ...
        <main class="content-area bg-white">
           ...
           <div class="row g-7 mt-3 d-flex flex-column" style="height: 250px;">
 ...
 <!-- button-->
    ...
    <div class="mt-auto d-flex justify-content-end gap-3 p-5 border-bottom">
        <button class="btn btn-outline-primary px-15">Save Draft</button>
        <button class="btn btn-primary px-15v">Submit</button>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#userMenu .submenu-item')[2];
