...
<head>
    ...
    <title>Payaasaan - Section Matching</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="fw-semibold mas">Section Matching</span>
            </div>
    ...
    <div style="display:flex; min-height: calc(100vh - 60px);">
        ...
        <main class="content-area bg-white">
            ...
            <!-- Section Matching List -->
             <div class="card p-0 mb-4" style="border-radius:12px; border:1px solid #E5E5E5;">
                    ...
                    <div class="d-flex justify-content-between align-items-center px-3 py-3"
                        ...
                        <h6 class="m-0 fw-semibold"> Section Matching List</h6>
                                ...
                                <table class="table table-bordered mb-0 custom-table ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>66224</td>
                                            <td>
                                                <i class="bi bi-pencil-square" style="font-size:20px; color:#007bff;">
                                                </i>
                                            </td>
            ...
            <div class="row g-2 mt-2">
                ...
                <!-- Deduction Component-->
                <div class="col-md-3">
                    <label class="form-label">Deduction Component<span class="text-danger">*</span></label>
                    <div class="position-relative">
                        <select class="form-select">
                ...
                <!-- Project Required-->
                <div class="col-md-3">
                    <label class="form-label"> Project Required<span class="text-danger">*</span></label>
                    <div class="position-relative">
                        <select class="form-select">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const pageSub = document.querySelectorAll('#transMenu .submenu-item')[8];
