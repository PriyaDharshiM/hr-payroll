...
<head>
    ...
    <title>Payaasaan - Professional Slabs</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Professional Tax Configuration</span>
            </div>
        ...
        <main class="content-area bg-white">
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label">Wage Periodicity <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                    ...
                    <div class="col-md-3">
                        <label class="form-label"> To Month <span class="text-danger">*</span> </label>
                        <div class="input-group">
                            <input type="date" class="form-control" placeholder="Select Date">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <label class="form-label">Deduction Periodicity <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                                <option>Select</option>
                            </select>
                    ...
                    <div class="col-md-3">
                        <label class="form-label"> Due Month <span class="text-danger">*</span> </label>
                        <div class="input-group">
                            <input type="date" class="form-control" placeholder="Select Date">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Employee Contribution">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label"> Slab Start From <span class="text-danger">*</span> </label>
                        <div class="input-group">
                            <input type="date" class="form-control" placeholder="Select Date">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <label class="form-label"> Slab Ent To <span class="text-danger">*</span> </label>
                        <div class="input-group">
                            <input type="date" class="form-control" placeholder="Select Date">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <input type="date" class="form-control" placeholder="Enter Value">
                        </div>
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Wages <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                                <option>Select</option>
                            </select>
                ...
                <div class="card p-0 cardborder">
                    ...
                    <div
                       class="cardheader">
                        Professional Tax Configuration List
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#configMenu .submenu-item')[2];
