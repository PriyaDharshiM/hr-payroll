...
<body>
    ...
    <form method="POST" action="{{ route('legalentity.update', [$company->company_id, $legalEntity->legalentity_id]) }}" enctype="multipart/form-data" id="legalForm">
        @csrf
        <input type="hidden" name="old_logo" value="{{ $legalEntity->legalentity_logo }}">
        <input type="hidden" name="status" id="formStatus" value="Saved" value="{{ $legalEntity->status }}">
    ...
    <select class="form-select" name="company_id" id="companySelect" required onchange="handleCompanyChange(this)">
        ...
        @foreach($companies as $comp)
            <option value="{{ $comp->company_id }}" 
                    {{ old('company_id',$legalEntity->company_id) == $comp->company_id ? 'selected' : '' }}>
                {{ $comp->company_name }}
            </option>
        @endforeach
    </select>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="legalentity_name"
                               value="{{ old('legalentity_name', $legalEntity->legalentity_name) }}" placeholder="Enter Legal Entity Name" required
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="legalentity_short_name"
                               value="{{ old('legalentity_short_name', $legalEntity->legalentity_short_name) }}" placeholder="Enter Short Name" required>
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">Reference No <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="reference_no"
                               value="{{ old('reference_no', $legalEntity->reference_no) }}" placeholder="1-10 alphanumeric" required maxlength="10"
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" rows="2" name="address1" placeholder="Enter Address">{{ old('address1', $legalEntity->address1) }}</textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Address 2</label>
                        <textarea class="form-control" rows="2" name="address2" placeholder="Enter Address">{{ old('address2', $legalEntity->address2) }}</textarea>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="state" required>
                            ...
                            <option value="Tamil Nadu" {{ $legalEntity->state == 'Tamil Nadu' ? 'selected' : '' }}>Tamil Nadu</option>
                            <option value="Kerala" {{ $legalEntity->state == 'Kerala' ? 'selected' : '' }}>Kerala</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="city" required>
                            ...
                            <option value="Madurai" {{ $legalEntity->city == 'Madurai' ? 'selected' : '' }}>Madurai</option>
                        </select>
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Pincode <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="pincode" value="{{ old('pincode', $legalEntity->pincode) }}"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="contact_person"
                               value="{{ old('contact_person', $legalEntity->contact_person) }}" placeholder="Enter Contact Person" required>
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Mobile Number <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="mobile_number"
                               value="{{ old('mobile_number', $legalEntity->mobile_number) }}" placeholder="Enter Mobile Number" required maxlength="10"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="telephone_number"
                               value="{{ old('telephone_number', $legalEntity->telephone_number) }}" placeholder="Enter Telephone Number">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Email <span class="text-danger">*</span></label>
                        <input type="email" class="form-control" name="email" value="{{ old('email', $legalEntity->email) }}"
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="url" class="form-control" name="legalentity_url"
                               value="{{ old('legalentity_url', $legalEntity->legalentity_url) }}" placeholder="https://example.com">
                    </div>
                    ...
                    <div class="col-md-2">
                        <label class="form-label">Legal Entity Logo</label>
                        @if($legalEntity->legalentity_logo)
                            <img src="{{ asset($legalEntity->legalentity_logo) }}"
                        ...
                        <div class="row g-4 registration-row mb-3">
                            ...
                            <div class="col-md-3">
                                <select class="form-select" name="registration_type[]">
                                    ...
                                    @foreach(['GST','CIN','PAN','TAN'] as $type)
                                        <option value="{{ $type }}"
                                            {{ $reg['type'] === $type ? 'selected' : '' }}>
                                            {{ $type }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-3">
                                ...
                                @if($reg['file'])
                                    <small class="d-block mt-1">
                                        <a href="{{ asset($reg['file']) }}" target="_blank">
                                            View existing file
                                        </a>
                                    </small>
                                @endif
                            ...
                            <div class="col-md-3">
                                <button type="button"
                                        ...
                                        onclick="this.closest('.registration-row').remove()">
