...
<head>
    ...
    <title>Payaasaan - Field Creation</title>
...
<body>
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom bg-white topbar-fixed"
        ...
        <div class="right-70 d-flex align-items-center justify-content-between" style="width:80%;padding:0px 10px;">
            ...
            <div class="breadcrumb-area">
                ...
                <span class="mas semibold">Field Creation</span>
            </div>
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row g-4 mb-3">
                    ...
                    <div class="col-md-3 d-flex" style="margin-top:50px;">
                                <label class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="checkfont">Allow Negative Value</span>
                                </label>
                            </div>
                    ...
                    <!-- Legal Entity -->
                    <div class="col-md-3">
                        <label class="form-label">Components Type <span class="text-danger">*</span></label>
                        <div class="position-relative">
                            <select class="form-select">
                ...
                <div class="row g-4 mb-3 align-items-end">
                    ...
                    <div class="col-md-3 d-flex" style="margin-top:50px;">
                                <label class="d-flex align-items-center gap-2">
                                    <input type="checkbox" checked>
                                    <span class="checkfont">Is Mandatory</span>
                                </label>
                            </div>
                            ...
                            <table class="table table-bordered mb-0 custom-table">
                                <thead>
                                    <tr>
                                        <th>S. No</th>
                                        <th>Field Name</th>
                                        <th>Earnings / Deduction</th>
                                        <th>Allow Negative Value</th>
                                    </tr>
                                </thead>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const pageSub = document.querySelectorAll('#masterMenu .submenu-item')[14];
